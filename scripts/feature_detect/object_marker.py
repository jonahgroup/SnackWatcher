...
#         Tested on Ubuntu Linux 10.04 and Mac OSX 10.10.3 with OpenCV 2.3.0.
# Usage     : python ObjectMarker.py object.txt background.txt inputdirectory
###############################################################################
...
def main():
    ...
    while True :
        ...
        if iKey == 81 or iKey == 112:
            current_file_index -= 1
            if current_file_index == -1 :
                current_file_index = len(files) - 1
            clear_roi()
        elif iKey == 83 or iKey == 110:
            current_file_index += 1
